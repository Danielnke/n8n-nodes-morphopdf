...
export const pdfToFormatOperationProperty: INodeProperties = {
  ...
  options: [
    ...
    { name: 'PDF to PowerPoint', value: 'pdfToPowerpoint', action: 'PDF to PowerPoint Tool', description: 'Convert PDF to PPTX format' },
...
export const formatToPdfOperationProperty: INodeProperties = {
  ...
  options: [
    ...
    { name: 'PowerPoint to PDF', value: 'powerpointToPdf', action: 'PowerPoint to PDF Tool', description: 'Convert PPTX to PDF' },
