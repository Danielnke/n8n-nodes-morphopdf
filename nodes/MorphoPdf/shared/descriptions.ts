...
export const documentManagementOperationProperty: INodeProperties = {
  ...
  options: [
    { name: 'Compress PDF', value: 'compress', action: 'Compress PDF tool', description: 'Reduce PDF file size while maintaining quality' },
    { name: 'Crop PDF', value: 'crop', action: 'Crop PDF tool', description: 'Crop page margins or specific areas' },
    { name: 'Merge PDF', value: 'merge', action: 'Merge PDF tool', description: 'Combine 2 or more PDF files into a single document' },
    { name: 'Organize PDF', value: 'organize', action: 'Organize PDF tool', description: 'Reorder, delete, or duplicate pages' },
    { name: 'Rotate PDF', value: 'rotate', action: 'Rotate PDF tool', description: 'Rotate all or specific pages by 90, 180, or 270 degrees' },
    { name: 'Split PDF', value: 'split', action: 'Split PDF tool', description: 'Split PDF by page ranges or extract individual pages' },
    { name: 'Watermark PDF', value: 'watermark', action: 'Watermark PDF tool', description: 'Add text or image watermark to pages' },
  ],
  default: 'merge',
};
...
export const pdfToFormatOperationProperty: INodeProperties = {
  ...
  options: [
    { name: 'PDF to Excel', value: 'pdfToExcel', action: 'Pdf to excel tool', description: 'Extract tables from PDF to XLSX' },
    { name: 'PDF to Image', value: 'pdfToImage', action: 'Pdf to image tool', description: 'Convert PDF pages to PNG or JPG' },
    { name: 'PDF to PowerPoint', value: 'pdfToPowerpoint', action: 'Pdf to power point tool', description: 'Convert PDF to PPTX format' },
    { name: 'PDF to Word', value: 'pdfToWord', action: 'Pdf to word tool', description: 'Convert PDF to DOCX format' },
  ],
  default: 'pdfToWord',
};
...
export const formatToPdfOperationProperty: INodeProperties = {
  ...
  options: [
    { name: 'Excel to PDF', value: 'excelToPdf', action: 'Excel to PDF tool', description: 'Convert XLSX to PDF' },
    { name: 'HTML to PDF', value: 'htmlToPdf', action: 'Html to pdf tool', description: 'Render webpage or HTML content to PDF' },
    { name: 'Image to PDF', value: 'imageToPdf', action: 'Image to PDF tool', description: 'Combine images into a PDF document' },
    { name: 'Markdown to PDF', value: 'markdownToPdf', action: 'Markdown to PDF tool', description: 'Convert Markdown text to PDF' },
    { name: 'PowerPoint to PDF', value: 'powerpointToPdf', action: 'Power point to pdf tool', description: 'Convert PPTX to PDF' },
    { name: 'Word to PDF', value: 'wordToPdf', action: 'Word to PDF tool', description: 'Convert DOCX to PDF' },
  ],
  default: 'wordToPdf',
};
...
export const securitySigningOperationProperty: INodeProperties = {
  ...
  options: [
    { name: 'Protect PDF', value: 'protect', action: 'Protect PDF tool', description: 'Add password and set permissions' },
    { name: 'Sign PDF', value: 'sign', action: 'Sign PDF tool', description: 'Add signature image to PDF' },
    { name: 'Unlock PDF', value: 'unlock', action: 'Unlock PDF tool', description: 'Remove password protection from PDF' },
  ],
  default: 'protect',
};
